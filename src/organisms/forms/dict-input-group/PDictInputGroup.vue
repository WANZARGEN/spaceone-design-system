...
import { DictInputGroupProps, DictItem } from '@/organisms/forms/dict-input-group/type';

import { makeProxy } from '@/util/composition-helpers';

const PDictInput = () => import('@/molecules/forms/dict-input/PDictInput.vue');
const PIconButton = () => import('@/molecules/buttons/icon-button/PIconButton.vue');
const PIconTextButton = () => import('@/molecules/buttons/icon-text-button/PIconTextButton.vue');
